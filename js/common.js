...
$(window).resize(function(){ var dwh = $(window).width(); $(".video").css("width",dwh); if(dwh < 768){$(".video").css("height",483); } });
/*---------------------------------------------------------------*/	
//scroll
